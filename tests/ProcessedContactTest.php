...
class ProcessedContactTest extends TestCase
{
    ...
    {
        parent::__construct();
        $this->completeContactString = trim(file_get_contents("tests/resources/processed_contact/processed_contact.json"));
        $this->incompleteContactString = trim(file_get_contents("tests/resources/processed_contact/list_processed_contact.json"));
        $this->minimalContactString = trim(file_get_contents("tests/resources/processed_contact/minimal_processed_contact.json"));
